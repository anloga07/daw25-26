...
import { Productos_Service } from '../../servicios/productos_service';
...
producto: any;
constructor(private articulos_Service: Productos_Service) { //modificamos el componente para consumir un servicio con los productos
  this.producto = this.articulos_Service.retornar();  //en ved de tenerlos declarados en el propio componente.
}

  /* producto: Componente[] = [{   //COMENTAMOS TODO ESTO YA QUE LOS PRODUCTOS LOS RECIBIMOS DE UN SERVICIO.
      id: 1,
